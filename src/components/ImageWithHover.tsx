                    ...
                    <DialogDescription className="flex items-start gap-10">
                        ...
                        <div className="w-3/5 flex flex-col justify-center">
                            ...
                            <p className="text-base leading-relaxed">
                                ...
                                embrace new adventures and take leaps of faith. The Fool
                                invites you to trust in the universe and let go of fear, for
                                life’s greatest journeys begin with a single step into the
                                unknown.
                            </p>
                            <br></br>
                            <br></br>
